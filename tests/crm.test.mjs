...
test('calculator selection retained but claimed client runtime discarded',()=>{const r=validateLead({...valid,calculator:{appliances:['light','tv','heating-boiler','light','cook','unknown'],hours:999}});assert.deepEqual(r.calculator.appliances,['light','tv','heating-boiler']);assert.equal(r.calculator.hours,undefined);});
