...
test('calculator selection retained but removed and unknown appliances discarded',()=>{const r=validateLead({...valid,calculator:{appliances:['light','tv','heating-boiler','light','boiler','pump','heat','cook','unknown'],hours:999}});assert.deepEqual(r.calculator.appliances,['light','tv','heating-boiler']);assert.equal(r.calculator.hours,undefined);});
